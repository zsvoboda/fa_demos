...
class AuthorizationApi(object):
    ...
    def api26_login_post_with_http_info(
        self,
        ...
        >>> thread = api.api26_login_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api26_logout_post_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_logout_post_with_http_info(async_req=True)
        >>> result = thread.get()
