...
class RemoteProtectionGroupsApi(object):
    ...
    def api25_remote_protection_groups_delete_with_http_info(
        self,
        ...
        >>> thread = api.api25_remote_protection_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.5/remote-protection-groups', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api25_remote_protection_groups_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_remote_protection_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api25_remote_protection_groups_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api25_remote_protection_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.5/remote-protection-groups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api25_remote_protection_groups_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api25_remote_protection_groups_patch_with_http_info(remote_protection_group, async_req=True)
        >>> result = thread.get()
        ...
        if remote_protection_group is None:
            raise TypeError("Missing the required parameter `remote_protection_group` when calling `api25_remote_protection_groups_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.5/remote-protection-groups', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
