...
class CertificatesApi(object):
    ...
    def api229_certificates_certificate_signing_requests_post_with_http_info(
        self,
        ...
        >>> thread = api.api229_certificates_certificate_signing_requests_post_with_http_info(certificate, async_req=True)
        >>> result = thread.get()
        ...
        if certificate is None:
            raise TypeError("Missing the required parameter `certificate` when calling `api229_certificates_certificate_signing_requests_post`")
        ...
        return self.api_client.call_api(
            '/api/2.29/certificates/certificate-signing-requests', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api229_certificates_delete_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api229_certificates_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api229_certificates_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api229_certificates_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api229_certificates_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api229_certificates_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api229_certificates_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api229_certificates_patch_with_http_info(certificate, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'certificate' is set
        if certificate is None:
            raise TypeError("Missing the required parameter `certificate` when calling `api229_certificates_patch`")
    ...
    def api229_certificates_post_with_http_info(
        self,
        certificate=None,  # type: models.CertificatePost
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api229_certificates_post_with_http_info(certificate, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'certificate' is set
        if certificate is None:
            raise TypeError("Missing the required parameter `certificate` when calling `api229_certificates_post`")
