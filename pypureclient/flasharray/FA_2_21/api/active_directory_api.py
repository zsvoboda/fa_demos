...
class ActiveDirectoryApi(object):
    ...
    def api221_active_directory_delete_with_http_info(
        self,
        ...
        >>> thread = api.api221_active_directory_delete_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api221_active_directory_delete`")
        ...
        return self.api_client.call_api(
            '/api/2.21/active-directory', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_active_directory_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_active_directory_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api221_active_directory_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api221_active_directory_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api221_active_directory_patch_with_http_info(
        self,
        names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_active_directory_patch_with_http_info(names, active_directory, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api221_active_directory_patch`")
        # verify the required parameter 'active_directory' is set
        if active_directory is None:
            raise TypeError("Missing the required parameter `active_directory` when calling `api221_active_directory_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.21/active-directory', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_active_directory_post_with_http_info(
        self,
        names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_active_directory_post_with_http_info(names, active_directory, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api221_active_directory_post`")
        # verify the required parameter 'active_directory' is set
        if active_directory is None:
            raise TypeError("Missing the required parameter `active_directory` when calling `api221_active_directory_post`")
        ...
        return self.api_client.call_api(
            '/api/2.21/active-directory', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
