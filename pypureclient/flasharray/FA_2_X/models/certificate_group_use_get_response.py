...
class CertificateGroupUseGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[CertificateGroupUse]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.CertificateGroupUse]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `CertificateGroupUseGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(CertificateGroupUseGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificateGroupUseGetResponse):
            return False
