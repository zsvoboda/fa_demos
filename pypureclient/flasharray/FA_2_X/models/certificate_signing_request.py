...
class CertificateSigningRequest(object):
    ...
    def __init__(
        self,
        certificate_signing_request=None,  # type: str
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `CertificateSigningRequest`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(CertificateSigningRequest, dict):
