...
class RemoteProtectionGroupSnapshotTransferGetResponse(object):
    ...
    swagger_types = {
        ...
        'total': 'list[RemoteProtectionGroupSnapshotTransfer]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.RemoteProtectionGroupSnapshotTransfer]
        errors=None,  # type: List[models.ErrorcontextresponseErrors]
        total=None,  # type: List[models.RemoteProtectionGroupSnapshotTransfer]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `RemoteProtectionGroupSnapshotTransferGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(RemoteProtectionGroupSnapshotTransferGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteProtectionGroupSnapshotTransferGetResponse):
            return False
