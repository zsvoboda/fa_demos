...
class DirectoryExportPost(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        Keyword args:
            ...
            server (Reference): Server to which the directory export is attached to. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoryExportPost`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoryExportPost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryExportPost):
            return False
