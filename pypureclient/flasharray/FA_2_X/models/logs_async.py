...
class LogsAsync(object):
    ...
    def __init__(
        ...
        hardware_components=None,  # type: List[models.HardwareComponent]
        ...
        Keyword args:
            ...
            hardware_components (list[HardwareComponent]): All of the hardware components for which logs are being processed. 
