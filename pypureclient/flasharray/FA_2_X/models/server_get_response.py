...
class ServerGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.Server]
    ):
        """
        Keyword args:
            ...
            items (list[Server]): The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field, if meaningful. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ServerGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ServerGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerGetResponse):
            return False
