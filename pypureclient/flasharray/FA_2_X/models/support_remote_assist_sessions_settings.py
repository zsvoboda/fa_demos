...
class SupportRemoteAssistSessionsSettings(object):
    """
    Attributes:
    ...
    def __init__(
        self,
        default_access_level=None,  # type: str
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SupportRemoteAssistSessionsSettings`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SupportRemoteAssistSessionsSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupportRemoteAssistSessionsSettings):
            return False
