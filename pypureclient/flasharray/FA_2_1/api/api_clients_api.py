...
class APIClientsApi(object):
    ...
    def api21_api_clients_delete_with_http_info(
        self,
        ...
        >>> thread = api.api21_api_clients_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api21_api_clients_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_api_clients_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_api_clients_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api21_api_clients_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api21_api_clients_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_api_clients_patch_with_http_info(api_clients, async_req=True)
        >>> result = thread.get()
        ...
        if api_clients is None:
            raise TypeError("Missing the required parameter `api_clients` when calling `api21_api_clients_patch`")
    ...
    def api21_api_clients_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api21_api_clients_post_with_http_info(api_clients, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'api_clients' is set
        if api_clients is None:
            raise TypeError("Missing the required parameter `api_clients` when calling `api21_api_clients_post`")
