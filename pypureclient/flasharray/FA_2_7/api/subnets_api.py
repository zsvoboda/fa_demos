...
class SubnetsApi(object):
    ...
    def api27_subnets_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_subnets_get`, must be a value greater than or equal to `0`")
    ...
    def api27_subnets_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_subnets_post_with_http_info(names, subnet, async_req=True)
        >>> result = thread.get()
