...
class HardwareApi(object):
    ...
    def api22_hardware_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api22_hardware_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api22_hardware_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api22_hardware_patch_with_http_info(
        self,
        ...
        if hardware is None:
            raise TypeError("Missing the required parameter `hardware` when calling `api22_hardware_patch`")
