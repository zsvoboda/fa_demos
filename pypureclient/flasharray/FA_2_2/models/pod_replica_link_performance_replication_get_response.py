...
class PodReplicaLinkPerformanceReplicationGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        Keyword args:
            ...
            total (list[PodReplicaLinkPerformanceReplication]): The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PodReplicaLinkPerformanceReplicationGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PodReplicaLinkPerformanceReplicationGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PodReplicaLinkPerformanceReplicationGetResponse):
            return False
