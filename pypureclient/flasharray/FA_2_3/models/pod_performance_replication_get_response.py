...
class PodPerformanceReplicationGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        Keyword args:
            ...
            total (list[PodPerformanceReplication]): The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PodPerformanceReplicationGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PodPerformanceReplicationGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PodPerformanceReplicationGetResponse):
            return False
