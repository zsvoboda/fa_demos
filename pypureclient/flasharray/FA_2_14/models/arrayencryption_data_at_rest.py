...
class ArrayencryptionDataAtRest(object):
    """
    Attributes:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ArrayencryptionDataAtRest`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ArrayencryptionDataAtRest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayencryptionDataAtRest):
            return False
