...
class VolumeSpaceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[VolumeSpace]',
        'total': 'list[VolumeSpace]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.VolumeSpace]
        total=None,  # type: List[models.VolumeSpace]
    ):
        """
        Keyword args:
            ...
            items (list[VolumeSpace]): Displays a list of all items after filtering. The values are displayed for each name if meaningful. If `total_only=true`, the `items` list will be empty. 
            total (list[VolumeSpace]): The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field if meaningful. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `VolumeSpaceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(VolumeSpaceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeSpaceGetResponse):
            return False
