...
class MaintenanceWindowsApi(object):
    ...
    def api228_maintenance_windows_delete_with_http_info(
        self,
        ...
        >>> thread = api.api228_maintenance_windows_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.28/maintenance-windows', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api228_maintenance_windows_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api228_maintenance_windows_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api228_maintenance_windows_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api228_maintenance_windows_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.28/maintenance-windows', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api228_maintenance_windows_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api228_maintenance_windows_post_with_http_info(maintenance_window, async_req=True)
        >>> result = thread.get()
        ...
        if maintenance_window is None:
            raise TypeError("Missing the required parameter `maintenance_window` when calling `api228_maintenance_windows_post`")
        ...
        return self.api_client.call_api(
            '/api/2.28/maintenance-windows', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
