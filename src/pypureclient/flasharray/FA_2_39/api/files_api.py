...
class FilesApi(object):
    ...
    def api239_files_post_with_http_info(
        self,
        ...
        >>> thread = api.api239_files_post_with_http_info(source_file, async_req=True)
        >>> result = thread.get()
        ...
        if source_file is None:
            raise TypeError("Missing the required parameter `source_file` when calling `api239_files_post`")
