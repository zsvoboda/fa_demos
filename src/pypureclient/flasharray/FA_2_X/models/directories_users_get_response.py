...
class DirectoriesUsersGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.DirectoryUser]
        ...
        Keyword args:
            ...
            items (list[DirectoryUser]): Displays a list of all items after filtering. If applicable, the values are displayed for each name. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoriesUsersGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoriesUsersGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoriesUsersGetResponse):
            return False
