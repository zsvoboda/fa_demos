...
class OffloadAzure(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            placement_strategy (str): The storage placement strategy is used for specifying tier, where data will be stored in a Microsoft Azure Blob Storage offload target. Valid value is \"azure-hot\", which is the default. 
