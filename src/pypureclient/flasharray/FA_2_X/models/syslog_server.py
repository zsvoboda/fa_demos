...
class SyslogServer(object):
    ...
    swagger_types = {
        ...
        'target_type': 'str',
        'services': 'list[str]',
        'sources': 'list[FixedReferenceNoId]',
        'uri': 'str'
    }
    ...
    def __init__(
        ...
        sources=None,  # type: List[models.FixedReferenceNoId]
        uri=None,  # type: str
    ):
        """
        Keyword args:
            ...
            sources (list[FixedReferenceNoId]): List of network interfaces the syslog server binds to, one for each controller. 
