...
class VchostCertificate(object):
    ...
    def __init__(
        ...
        """
        Keyword args:
            certificate (ReferenceWithType): A reference to the certificate that will be presented to clients accessing the referenced `vchost` using any of the network addresses defined by `endpoints`. 
