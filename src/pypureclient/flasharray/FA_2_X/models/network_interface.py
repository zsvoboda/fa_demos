...
class NetworkInterface(object):
    ...
    swagger_types = {
        ...
        'interface_type': 'str',
        'max_speed': 'int',
        'servers': 'list[FixedReferenceWithType]',
        'services': 'list[str]',
        'speed': 'int'
    }
    ...
    def __init__(
        ...
        servers=None,  # type: List[models.FixedReferenceWithType]
        ...
        Keyword args:
            ...
            max_speed (int): Configured speed of the specified network interface or Fibre Channel port (in Gb/s). Typically this is the maximum speed of the port or bond represented by the network interface. 
            servers (list[FixedReferenceWithType]): List of servers associated with the specified network interface for data ingress. 
            services (list[str]): The services provided by the specified network interface or Fibre Channel port. 
            speed (int): This field has been deprecated. Please use the \"max_speed\" field, as it contains the same information. 
        """
        if name is not None:
            self.name = name
