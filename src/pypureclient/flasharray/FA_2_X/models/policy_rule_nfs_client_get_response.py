...
class PolicyRuleNfsClientGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[PolicyRuleNfsClient]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PolicyRuleNfsClient]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyRuleNfsClientGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyRuleNfsClientGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleNfsClientGetResponse):
            return False
