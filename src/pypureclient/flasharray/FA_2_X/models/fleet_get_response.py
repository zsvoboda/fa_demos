...
class FleetGetResponse(object):
    ...
    def __init__(
        ...
        items=None,  # type: List[models.Fleet]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `FleetGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(FleetGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FleetGetResponse):
            return False
