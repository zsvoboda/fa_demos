...
class WorkloadPlacementRecommendation(object):
    ...
    def __init__(
        ...
        recommendation_engine=None,  # type: str
        ...
        Keyword args:
            ...
            recommendation_engine (str): This parameter defines which engine to use for recommendations. Possible values include `pure1`, `local`, and `best-available`. If not specified, defaults to 'best-available' which may mix results of different engines, while 'pure1' and 'local' restrict the used engine. 
