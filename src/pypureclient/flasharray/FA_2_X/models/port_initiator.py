...
class PortInitiator(object):
    ...
    swagger_types = {
        ...
        'encryption': 'PortInitiatorEncryption',
    ...
    def __init__(
        ...
        encryption=None,  # type: models.PortInitiatorEncryption
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PortInitiator`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PortInitiator, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortInitiator):
            return False
