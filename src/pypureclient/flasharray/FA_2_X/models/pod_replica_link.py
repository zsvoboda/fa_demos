...
class PodReplicaLink(object):
    ...
    swagger_types = {
        ...
        'remotes': 'list[FixedReferenceWithType]',
        'status': 'str'
    }
    ...
    def __init__(
        ...
        remotes=None,  # type: List[models.FixedReferenceWithType]
        ...
        Keyword args:
            ...
            remotes (list[FixedReferenceWithType]): A list of remote arrays or realms that share this pod.
