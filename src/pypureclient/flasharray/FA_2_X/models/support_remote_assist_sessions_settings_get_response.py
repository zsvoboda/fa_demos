...
class SupportRemoteAssistSessionsSettingsGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[SupportRemoteAssistSessionsSettings]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.SupportRemoteAssistSessionsSettings]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `SupportRemoteAssistSessionsSettingsGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(SupportRemoteAssistSessionsSettingsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupportRemoteAssistSessionsSettingsGetResponse):
            return False
