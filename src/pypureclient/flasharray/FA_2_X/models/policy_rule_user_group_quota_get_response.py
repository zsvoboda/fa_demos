...
class PolicyRuleUserGroupQuotaGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[PolicyRuleUserGroupQuota]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PolicyRuleUserGroupQuota]
        ...
        Keyword args:
            ...
            items (list[PolicyRuleUserGroupQuota]): Displays a list of all items after filtering. The values are displayed for each name, if meaningful. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyRuleUserGroupQuotaGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyRuleUserGroupQuotaGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleUserGroupQuotaGetResponse):
            return False
