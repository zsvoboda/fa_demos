...
class DirectorySnapshotGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[DirectorySnapshot]',
        'errors': 'list[ErrorcontextresponseErrors]',
        'total': 'list[DirectorySnapshot]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.DirectorySnapshot]
        errors=None,  # type: List[models.ErrorcontextresponseErrors]
        total=None,  # type: List[models.DirectorySnapshot]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectorySnapshotGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectorySnapshotGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectorySnapshotGetResponse):
            return False
