...
class DirectoryGroupQuotasGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[DirectoryGroupQuota]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.DirectoryGroupQuota]
        ...
        Keyword args:
            ...
            items (list[DirectoryGroupQuota]): Displays a list of all items after filtering. If applicable, the values are displayed for each name. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoryGroupQuotasGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoryGroupQuotasGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryGroupQuotasGetResponse):
            return False
