...
class WorkloadPlacementRecommendationTargetLoadProjections(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        Keyword args:
            ...
            projection_baseline (WorkloadPlacementRecommendationProjection): The projected baseline load on the target, without the workload on this target. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `WorkloadPlacementRecommendationTargetLoadProjections`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(WorkloadPlacementRecommendationTargetLoadProjections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorkloadPlacementRecommendationTargetLoadProjections):
            return False
