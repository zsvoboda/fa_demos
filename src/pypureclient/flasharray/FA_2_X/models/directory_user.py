...
class DirectoryUser(object):
    ...
    swagger_types = {
        ...
        'limited_by': 'UserGroupQuotaLimitedBy',
        'path': 'str',
    ...
    def __init__(
        ...
        limited_by=None,  # type: models.UserGroupQuotaLimitedBy
        path=None,  # type: str
        space=None,  # type: models.UserGroupSpace
        ...
        Keyword args:
            ...
            limited_by (UserGroupQuotaLimitedBy): The user-group-quota or quota policy that is limiting usage for this user in this managed directory. This policy defines the total amount of space allowed for this user or this managed directory. The returned value contains two parts&#58; the name of the policy and the managed directory to which the policy is attached. 
            path (str): Absolute path of the managed directory in the file system. 
            space (UserGroupSpace): The logical space owned by the user.
            user (UserGroup): A user which has content in the managed directory.
        """
        if id is not None:
            self.id = id
        if name is not None:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoryUser`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoryUser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryUser):
            return False
