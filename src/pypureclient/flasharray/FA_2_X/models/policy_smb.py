...
class PolicySmb(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            continuous_availability_enabled (bool): Returns a value of `true` if continuous availability is enabled on the policy. When continuous availability is enabled on a policy, file shares are accessible during otherwise disruptive scenarios such as temporary network outages, controller upgrades or failovers. 
