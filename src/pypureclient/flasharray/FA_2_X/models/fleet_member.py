...
class FleetMember(object):
    ...
    """
    swagger_types = {
        'coordinator_of': 'list[FixedReferenceWithType]',
    ...
    def __init__(
        self,
        coordinator_of=None,  # type: List[models.FixedReferenceWithType]
        ...
        """
        Keyword args:
            coordinator_of (list[FixedReferenceWithType]): List of array groups that the member is the coordinator of. 
            fleet (FixedReferenceWithTypeAndLocation)
            member (FixedReferenceWithTypeAndLocation)
        ...
        """
        if coordinator_of is not None:
            self.coordinator_of = coordinator_of
