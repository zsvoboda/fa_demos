...
class LocalDirectoryServiceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[LocalDirectoryService]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.LocalDirectoryService]
        ...
        Keyword args:
            ...
            items (list[LocalDirectoryService]): Displays a list of all items after filtering. The values are displayed for each name, if meaningful. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `LocalDirectoryServiceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(LocalDirectoryServiceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocalDirectoryServiceGetResponse):
            return False
