...
class TestResultWithResource(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        resource=None,  # type: models.FixedReferenceNoId
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `TestResultWithResource`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(TestResultWithResource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TestResultWithResource):
            return False
