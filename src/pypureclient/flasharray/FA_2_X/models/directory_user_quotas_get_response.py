...
class DirectoryUserQuotasGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.DirectoryUserQuota]
        ...
        Keyword args:
            ...
            items (list[DirectoryUserQuota]): Displays a list of all items after filtering. If applicable, the values are displayed for each name. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoryUserQuotasGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoryUserQuotasGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryUserQuotasGetResponse):
            return False
