...
class ArrayConnectionPatch(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            connection_key (str): The connection key of the target array. It is required when `encryption` is changed, or when `type` is changed from `async-replication` to `sync-replication`. 
