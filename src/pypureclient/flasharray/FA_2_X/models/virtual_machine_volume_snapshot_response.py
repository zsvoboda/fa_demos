...
class VirtualMachineVolumeSnapshotResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[VirtualMachineVolumeSnapshot]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.VirtualMachineVolumeSnapshot]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `VirtualMachineVolumeSnapshotResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(VirtualMachineVolumeSnapshotResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualMachineVolumeSnapshotResponse):
            return False
