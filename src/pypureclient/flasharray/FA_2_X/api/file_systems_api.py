...
class FileSystemsApi(object):
    ...
    def api2_x_file_systems_delete_with_http_info(
        self,
        ...
        >>> thread = api.api2_x_file_systems_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api2_x_file_systems_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_file_systems_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_file_systems_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_file_systems_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api2_x_file_systems_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_file_systems_patch_with_http_info(file_system, async_req=True)
        >>> result = thread.get()
        ...
        if file_system is None:
            raise TypeError("Missing the required parameter `file_system` when calling `api2_x_file_systems_patch`")
    ...
    def api2_x_file_systems_post_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        :param str x_request_id: Supplied by client during request or generated by server. 
        :param list[str] context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request.  Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. 
        :param list[str] add_to_policy_ids: The root directories of the file systems will become members of the specified policies along with creation. Enter multiple ids in comma-separated format. 
        :param list[str] add_to_policy_names: The root directories of the file systems will become members of the specified policies along with creation. Enter multiple names in a comma-separated format. 
        :param bool with_default_protection: If specified as `true`, the initial protection of the root directories of the newly created file systems will be the union of the container default protection configuration and either `add_to_policy_names` or `add_to_policy_ids`. If specified as `false`, the default protection of the container will not be applied automatically. The initial protection of the root directories of the newly created file systems will be configured by either `add_to_policy_names` or `add_to_policy_ids`. If not specified, defaults to `true`. 
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        :param bool _return_http_data_only: Returns only data field.
        :param bool _preload_content: Response is converted into objects.
        :param int _request_timeout: Total request timeout in seconds.
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api2_x_file_systems_post`")
