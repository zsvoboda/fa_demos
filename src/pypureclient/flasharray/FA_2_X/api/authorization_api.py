...
class AuthorizationApi(object):
    ...
    def api2_x_login_post_with_http_info(
        self,
        login=None,  # type: models.LoginPost
    ...
    def api2_x_logout_post_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_logout_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def oauth210_token_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oauth210_token_post_with_http_info(subject_token_type, grant_type, subject_token, async_req=True)
        >>> result = thread.get()
