...
class SyslogApi(object):
    ...
    def api2_x_syslog_servers_delete_with_http_info(
        self,
        ...
        >>> thread = api.api2_x_syslog_servers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api2_x_syslog_servers_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_syslog_servers_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_syslog_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api2_x_syslog_servers_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_patch_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
        ...
        if syslog_server is None:
            raise TypeError("Missing the required parameter `syslog_server` when calling `api2_x_syslog_servers_patch`")
    ...
    def api2_x_syslog_servers_post_with_http_info(
        self,
        syslog_server=None,  # type: models.SyslogServer
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_post_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'syslog_server' is set
        if syslog_server is None:
            raise TypeError("Missing the required parameter `syslog_server` when calling `api2_x_syslog_servers_post`")
    ...
    def api2_x_syslog_servers_settings_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        allow_errors=None,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_settings_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_syslog_servers_settings_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_syslog_servers_settings_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.X/syslog-servers/settings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_syslog_servers_settings_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_settings_patch_with_http_info(syslog_server_settings, async_req=True)
        >>> result = thread.get()
        ...
        if syslog_server_settings is None:
            raise TypeError("Missing the required parameter `syslog_server_settings` when calling `api2_x_syslog_servers_settings_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.X/syslog-servers/settings', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_syslog_servers_test_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        allow_errors=None,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_syslog_servers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_syslog_servers_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_syslog_servers_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.X/syslog-servers/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
