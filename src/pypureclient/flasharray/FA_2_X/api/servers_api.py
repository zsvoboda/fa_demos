...
class ServersApi(object):
    ...
    def api2_x_servers_delete_with_http_info(
        self,
        authorization=None,  # type: str
        cascade_delete=None,  # type: List[str]
        ...
        >>> thread = api.api2_x_servers_delete_with_http_info(async_req=True)
        >>> result = thread.get()

        :param str authorization: Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`) 
        :param list[str] cascade_delete: The resource types to delete when deleting this object. It will fail if the resources are referenced by other objects. Valid values include `directory-services`. 
        ...
        if cascade_delete is not None:
            if not isinstance(cascade_delete, list):
        ...
        if 'cascade_delete' in params:
            query_params.append(('cascade_delete', params['cascade_delete']))
            collection_formats['cascade_delete'] = 'csv'
    ...
    def api2_x_servers_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        # type: (...) -> models.ServerGetResponse
        """List servers

        Displays a list of servers.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_servers_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ServerGetResponse',
            auth_settings=auth_settings,
            async_req=async_req,
            _return_http_data_only=_return_http_data_only,
            _preload_content=_preload_content,
    ...
    def api2_x_servers_patch_with_http_info(
        self,
        server=None,  # type: models.ServerPatch
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        context_names=None,  # type: List[str]
        ids=None,  # type: List[str]
        ...
        # type: (...) -> models.ServerResponse
        """Modify server

        Modifies server details.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_servers_patch_with_http_info(server, async_req=True)
        >>> result = thread.get()

        :param ServerPatch server: (required)
        :param str authorization: Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`) 
        :param str x_request_id: Supplied by client during request or generated by server. 
        :param list[str] context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request.  Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. 
        :param list[str] ids: Performs the operation on the unique resource IDs specified. Enter multiple resource IDs in comma-separated format. The `ids` or `names` parameter is required, but they cannot be set together. 
        ...
        if server is None:
            raise TypeError("Missing the required parameter `server` when calling `api2_x_servers_patch`")
    ...
    def api2_x_servers_post_with_http_info(
        self,
        authorization=None,  # type: str
        context_names=None,  # type: List[str]
        names=None,  # type: List[str]
        create_local_directory_service=None,  # type: str
        x_request_id=None,  # type: str
        server=None,  # type: models.ServerPost
        async_req=False,  # type: bool
        _return_http_data_only=False,  # type: bool
        _preload_content=True,  # type: bool
        _request_timeout=None,  # type: Optional[int]
        ...
        Creates server on the local array. Server must be given a name that is unique in realm 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_servers_post_with_http_info(async_req=True)
        >>> result = thread.get()

        :param str authorization: Access token (in JWT format) required to use any API endpoint (except `/oauth2`, `/login`, and `/logout`) 
        :param list[str] context_names: Performs the operation on the context specified. If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet. If not specified, the context will default to the array that received this request.  Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided `context`. 
        :param list[str] names: Performs the operation on the unique name specified. Enter multiple names in comma-separated format. The name is expected to be fully qualified, meaning if the object is contained in some context, the corresponding name would provide complete information about the containment hierarchy. For example, `name01,realm01::name01,realm01::pod01::name01`. 
        :param str create_local_directory_service: The name of the local directory service object to be created and associated to the server. This parameter can't be used together with `local_directory_service` property in the request entity. 
        :param str x_request_id: Supplied by client during request or generated by server. 
        :param ServerPost server:
        :param bool async_req: Request runs in separate thread and method returns multiprocessing.pool.ApplyResult.
        :param bool _return_http_data_only: Returns only data field.
        :param bool _preload_content: Response is converted into objects.
        :param int _request_timeout: Total request timeout in seconds.
        ...
        if 'names' in params:
            query_params.append(('names', params['names']))
            collection_formats['names'] = 'csv'
        if 'create_local_directory_service' in params:
            query_params.append(('create_local_directory_service', params['create_local_directory_service']))
