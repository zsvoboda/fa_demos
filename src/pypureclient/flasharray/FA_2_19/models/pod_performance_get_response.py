...
class PodPerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[PodPerformance]',
        'total': 'list[PodPerformance]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PodPerformance]
        total=None,  # type: List[models.PodPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PodPerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PodPerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PodPerformanceGetResponse):
            return False
