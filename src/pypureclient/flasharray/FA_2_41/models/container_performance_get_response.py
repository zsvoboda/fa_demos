...
class ContainerPerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ContainerPerformance]',
        'total': 'list[ContainerPerformance]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ContainerPerformance]
        total=None,  # type: List[models.ContainerPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ContainerPerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ContainerPerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContainerPerformanceGetResponse):
            return False
