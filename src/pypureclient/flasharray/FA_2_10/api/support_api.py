...
class SupportApi(object):
    ...
    def api210_support_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api210_support_get`, must be a value greater than or equal to `0`")
    ...
    def api210_support_test_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api210_support_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
