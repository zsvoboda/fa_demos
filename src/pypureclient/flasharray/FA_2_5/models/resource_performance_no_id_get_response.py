...
class ResourcePerformanceNoIdGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ResourcePerformanceNoId]',
        'total': 'list[ResourcePerformanceNoId]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ResourcePerformanceNoId]
        total=None,  # type: List[models.ResourcePerformanceNoId]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ResourcePerformanceNoIdGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ResourcePerformanceNoIdGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourcePerformanceNoIdGetResponse):
            return False
