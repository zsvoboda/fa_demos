...
class RemoteVolumeSnapshotsApi(object):
    ...
    def api221_remote_volume_snapshots_delete_with_http_info(
        self,
        ...
        >>> thread = api.api221_remote_volume_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.21/remote-volume-snapshots', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_remote_volume_snapshots_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_remote_volume_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api221_remote_volume_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api221_remote_volume_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.21/remote-volume-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_remote_volume_snapshots_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_remote_volume_snapshots_patch_with_http_info(remote_volume_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if remote_volume_snapshot is None:
            raise TypeError("Missing the required parameter `remote_volume_snapshot` when calling `api221_remote_volume_snapshots_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.21/remote-volume-snapshots', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_remote_volume_snapshots_post_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        source_ids=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_remote_volume_snapshots_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.21/remote-volume-snapshots', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api221_remote_volume_snapshots_transfer_get_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api221_remote_volume_snapshots_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api221_remote_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api221_remote_volume_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.21/remote-volume-snapshots/transfer', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
