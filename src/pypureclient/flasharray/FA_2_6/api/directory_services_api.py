...
class DirectoryServicesApi(object):
    ...
    def api26_directory_services_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_directory_services_get`, must be a value greater than or equal to `0`")
    ...
    def api26_directory_services_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_directory_services_patch_with_http_info(names, directory_service, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api26_directory_services_patch`")
    ...
    def api26_directory_services_roles_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_directory_services_roles_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api26_directory_services_roles_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_directory_services_roles_patch_with_http_info(role_names, directory_service_roles, async_req=True)
        >>> result = thread.get()
        ...
        if role_names is None:
            raise TypeError("Missing the required parameter `role_names` when calling `api26_directory_services_roles_patch`")
    ...
    def api26_directory_services_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api26_directory_services_test_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api26_directory_services_test_get`")

        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api26_directory_services_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api26_directory_services_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
