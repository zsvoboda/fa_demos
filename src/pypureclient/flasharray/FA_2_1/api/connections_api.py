...
class ConnectionsApi(object):
    ...
    def api21_connections_delete_with_http_info(
        self,
    ...
    def api21_connections_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_connections_get`, must be a value greater than or equal to `0`")
    ...
    def api21_connections_post_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        host_group_names=None,  # type: List[str]
