...
class KMIPApi(object):
    ...
    def api23_kmip_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api23_kmip_get`, must be a value greater than or equal to `0`")
    ...
    def api23_kmip_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api23_kmip_patch_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api23_kmip_patch`")
    ...
    def api23_kmip_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api23_kmip_post_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'kmip' is set
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api23_kmip_post`")
    ...
    def api23_kmip_test_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api23_kmip_test_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api23_kmip_test_get`")
