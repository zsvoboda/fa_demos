...
class SubscriptionAssetsApi(object):
    ...
    def api230_subscription_assets_get_with_http_info(
        self,
        ...
        >>> thread = api.api230_subscription_assets_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api230_subscription_assets_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api230_subscription_assets_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.30/subscription-assets', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
