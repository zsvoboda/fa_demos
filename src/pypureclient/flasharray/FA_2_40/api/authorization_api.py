...
class AuthorizationApi(object):
    ...
    def api240_login_post_with_http_info(
        self,
        ...
        >>> thread = api.api240_login_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api240_logout_post_with_http_info(
        self,
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api240_logout_post_with_http_info(async_req=True)
        >>> result = thread.get()
