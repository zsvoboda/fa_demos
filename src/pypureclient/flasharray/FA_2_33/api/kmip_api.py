...
class KMIPApi(object):
    ...
    def api233_kmip_delete_with_http_info(
        self,
        ...
        >>> thread = api.api233_kmip_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api233_kmip_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api233_kmip_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api233_kmip_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api233_kmip_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api233_kmip_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api233_kmip_patch_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api233_kmip_patch`")
    ...
    def api233_kmip_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api233_kmip_post_with_http_info(kmip, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'kmip' is set
        if kmip is None:
            raise TypeError("Missing the required parameter `kmip` when calling `api233_kmip_post`")
    ...
    def api233_kmip_test_get_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api233_kmip_test_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api233_kmip_test_get`")
