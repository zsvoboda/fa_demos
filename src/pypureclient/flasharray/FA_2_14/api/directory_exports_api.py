...
class DirectoryExportsApi(object):
    ...
    def api214_directory_exports_delete_with_http_info(
        self,
        ...
        >>> thread = api.api214_directory_exports_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-exports', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_directory_exports_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_directory_exports_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api214_directory_exports_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api214_directory_exports_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-exports', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api214_directory_exports_post_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api214_directory_exports_post_with_http_info(exports, async_req=True)
        >>> result = thread.get()
        ...
        if exports is None:
            raise TypeError("Missing the required parameter `exports` when calling `api214_directory_exports_post`")
        ...
        return self.api_client.call_api(
            '/api/2.14/directory-exports', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
