...
class NetworkInterfacesApi(object):
    ...
    def api27_network_interfaces_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_network_interfaces_patch_with_http_info(network, async_req=True)
        >>> result = thread.get()
        ...
        if network is None:
            raise TypeError("Missing the required parameter `network` when calling `api27_network_interfaces_patch`")
    ...
    def api27_network_interfaces_performance_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        filter=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_network_interfaces_performance_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'resolution' in params and params['resolution'] < 0:
            raise ValueError("Invalid value for parameter `resolution` when calling `api27_network_interfaces_performance_get`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api27_network_interfaces_performance_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api27_network_interfaces_performance_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.7/network-interfaces/performance', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api27_network_interfaces_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api27_network_interfaces_post_with_http_info(network, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'network' is set
        if network is None:
            raise TypeError("Missing the required parameter `network` when calling `api27_network_interfaces_post`")
