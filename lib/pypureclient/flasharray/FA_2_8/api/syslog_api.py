...
class SyslogApi(object):
    ...
    def api28_syslog_servers_delete_with_http_info(
        ...
        >>> thread = api.api28_syslog_servers_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api28_syslog_servers_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_syslog_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_syslog_servers_get`, must be a value greater than or equal to `0`")
    ...
    def api28_syslog_servers_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_syslog_servers_patch_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
    ...
    def api28_syslog_servers_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_syslog_servers_post_with_http_info(syslog_server, async_req=True)
        >>> result = thread.get()
    ...
    def api28_syslog_servers_settings_get_with_http_info(
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_syslog_servers_settings_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
    ...
    def api28_syslog_servers_settings_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_syslog_servers_settings_patch_with_http_info(syslog_server_settings, async_req=True)
        >>> result = thread.get()
        ...
        if syslog_server_settings is None:
            raise TypeError("Missing the required parameter `syslog_server_settings` when calling `api28_syslog_servers_settings_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.8/syslog-servers/settings', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api28_syslog_servers_test_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        filter=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_syslog_servers_test_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_syslog_servers_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_syslog_servers_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.8/syslog-servers/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
