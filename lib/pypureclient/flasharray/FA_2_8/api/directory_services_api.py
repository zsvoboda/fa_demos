...
class DirectoryServicesApi(object):
    ...
    def api28_directory_services_get_with_http_info(
        self,
        ...
        >>> thread = api.api28_directory_services_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_directory_services_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.8/directory-services', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api28_directory_services_patch_with_http_info(
        self,
        names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_patch_with_http_info(names, directory_service, async_req=True)
        >>> result = thread.get()
        ...
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api28_directory_services_patch`")
        # verify the required parameter 'directory_service' is set
        if directory_service is None:
            raise TypeError("Missing the required parameter `directory_service` when calling `api28_directory_services_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.8/directory-services', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api28_directory_services_roles_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        continuation_token=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_roles_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_roles_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_directory_services_roles_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.8/directory-services/roles', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api28_directory_services_roles_patch_with_http_info(
        self,
        role_names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_roles_patch_with_http_info(role_names, directory_service_roles, async_req=True)
        >>> result = thread.get()
        ...
        if role_names is None:
            raise TypeError("Missing the required parameter `role_names` when calling `api28_directory_services_roles_patch`")
        # verify the required parameter 'directory_service_roles' is set
        if directory_service_roles is None:
            raise TypeError("Missing the required parameter `directory_service_roles` when calling `api28_directory_services_roles_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.8/directory-services/roles', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api28_directory_services_test_get_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api28_directory_services_test_get_with_http_info(names, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'names' is set
        if names is None:
            raise TypeError("Missing the required parameter `names` when calling `api28_directory_services_test_get`")

        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api28_directory_services_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api28_directory_services_test_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.8/directory-services/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
