...
class DirectoryPerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[DirectoryPerformance]',
        'total': 'list[DirectoryPerformance]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.DirectoryPerformance]
        total=None,  # type: List[models.DirectoryPerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `DirectoryPerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(DirectoryPerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirectoryPerformanceGetResponse):
            return False
