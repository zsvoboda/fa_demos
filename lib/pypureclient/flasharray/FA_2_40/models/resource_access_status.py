...
class ResourceAccessStatus(object):
    """
    Attributes:
    ...
    """
    swagger_types = {
        'created_by': 'list[ResourceAccessStatusCreatedBy]',
    ...
    def __init__(
        self,
        created_by=None,  # type: List[models.ResourceAccessStatusCreatedBy]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ResourceAccessStatus`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ResourceAccessStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceAccessStatus):
            return False
