...
class SMTPApi(object):
    ...
    def api240_smtp_servers_get_with_http_info(
        self,
        ...
        >>> thread = api.api240_smtp_servers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api240_smtp_servers_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api240_smtp_servers_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api240_smtp_servers_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api240_smtp_servers_patch_with_http_info(smtp, async_req=True)
        >>> result = thread.get()
        ...
        if smtp is None:
            raise TypeError("Missing the required parameter `smtp` when calling `api240_smtp_servers_patch`")
