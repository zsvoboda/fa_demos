...
class RemoteProtectionGroupSnapshotsApi(object):
    ...
    def api21_remote_protection_group_snapshots_delete_with_http_info(
        self,
    ...
    def api21_remote_protection_group_snapshots_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_remote_protection_group_snapshots_get`, must be a value greater than or equal to `0`")
    ...
    def api21_remote_protection_group_snapshots_patch_with_http_info(
        self,
        ...
        if remote_protection_group_snapshot is None:
            raise TypeError("Missing the required parameter `remote_protection_group_snapshot` when calling `api21_remote_protection_group_snapshots_patch`")
    ...
    def api21_remote_protection_group_snapshots_transfer_get_with_http_info(
        self,
        names=None,  # type: List[str]
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api21_remote_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
