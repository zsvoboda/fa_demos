...
class VchostConnectionsApi(object):
    ...
    def api235_vchost_connections_delete_with_http_info(
        self,
        ...
        >>> thread = api.api235_vchost_connections_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.35/vchost-connections', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api235_vchost_connections_get_with_http_info(
        self,
        all_vchosts=None,  # type: bool
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api235_vchost_connections_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api235_vchost_connections_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api235_vchost_connections_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.35/vchost-connections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api235_vchost_connections_post_with_http_info(
        self,
        all_vchosts=None,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api235_vchost_connections_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.35/vchost-connections', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
