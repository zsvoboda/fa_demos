...
class ResourcePerformanceByArrayGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ResourcePerformanceByArray]',
        'total': 'list[ResourcePerformanceByArray]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ResourcePerformanceByArray]
        total=None,  # type: List[models.ResourcePerformanceByArray]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ResourcePerformanceByArrayGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ResourcePerformanceByArrayGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourcePerformanceByArrayGetResponse):
            return False
