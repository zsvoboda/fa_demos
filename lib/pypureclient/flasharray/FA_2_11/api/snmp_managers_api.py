...
class SNMPManagersApi(object):
    ...
    def api211_snmp_managers_delete_with_http_info(
        self,
    ...
    def api211_snmp_managers_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_snmp_managers_get`, must be a value greater than or equal to `0`")
    ...
    def api211_snmp_managers_patch_with_http_info(
        self,
    ...
    def api211_snmp_managers_post_with_http_info(
        self,
    ...
    def api211_snmp_managers_test_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        filter=None,  # type: str
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api211_snmp_managers_test_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
        ...
        return self.api_client.call_api(
            '/api/2.11/snmp-managers/test', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
