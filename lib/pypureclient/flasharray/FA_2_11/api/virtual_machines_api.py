...
class VirtualMachinesApi(object):
    ...
    def api211_virtual_machines_patch_with_http_info(
        self,
        ...
        >>> thread = api.api211_virtual_machines_patch_with_http_info(virtual_machine, async_req=True)
        >>> result = thread.get()
        ...
        if virtual_machine is None:
            raise TypeError("Missing the required parameter `virtual_machine` when calling `api211_virtual_machines_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.11/virtual-machines', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api211_virtual_machines_post_with_http_info(
        self,
        virtual_machine=None,  # type: models.VirtualMachinePost
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api211_virtual_machines_post_with_http_info(virtual_machine, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'virtual_machine' is set
        if virtual_machine is None:
            raise TypeError("Missing the required parameter `virtual_machine` when calling `api211_virtual_machines_post`")
        ...
        return self.api_client.call_api(
            '/api/2.11/virtual-machines', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
