...
class ResourcePodSpaceGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[ResourcePodSpace]): Displays a list of all items after filtering. The values are displayed for each name, if applicable. If `total_only=true`, the `items` list will be empty. 
            total (list[ResourcePodSpace]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field. 
        """
