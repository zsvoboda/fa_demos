...
class FilesApi(object):
    ...
    def api227_files_post_with_http_info(
        self,
        ...
        >>> thread = api.api227_files_post_with_http_info(source_file, async_req=True)
        >>> result = thread.get()
        ...
        if source_file is None:
            raise TypeError("Missing the required parameter `source_file` when calling `api227_files_post`")
