...
class PolicyAuditFilePatch(object):
    """
    Attributes:
    ...
    swagger_types = {
        'name': 'str',
        'enabled': 'bool',
        'log_targets': 'list[ReferenceNoIdWithType]'
    }
    ...
    def __init__(
        ...
        log_targets=None,  # type: List[models.ReferenceNoIdWithType]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyAuditFilePatch`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyAuditFilePatch, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyAuditFilePatch):
            return False
