...
class ProtectionGroupSnapshotGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'total': 'list[ProtectionGroupSnapshot]'
    }
    ...
    def __init__(
        ...
        total=None,  # type: List[models.ProtectionGroupSnapshot]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ProtectionGroupSnapshotGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ProtectionGroupSnapshotGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtectionGroupSnapshotGetResponse):
            return False
