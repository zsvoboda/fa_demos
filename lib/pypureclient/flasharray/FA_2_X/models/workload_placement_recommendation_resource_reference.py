...
class WorkloadPlacementRecommendationResourceReference(object):
    """
    Attributes:
    ...
    """
    swagger_types = {
        'allowed_values': 'list[ReferenceWithType]'
    }
    ...
    def __init__(
        self,
        allowed_values,  # type: List[models.ReferenceWithType]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `WorkloadPlacementRecommendationResourceReference`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(WorkloadPlacementRecommendationResourceReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorkloadPlacementRecommendationResourceReference):
            return False
