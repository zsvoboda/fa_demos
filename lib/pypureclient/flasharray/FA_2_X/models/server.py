...
class Server(object):
    ...
    swagger_types = {
        ...
        'created': 'int',
        'directory_services': 'list[FixedReferenceWithType]',
        'dns': 'list[FixedReferenceWithType]',
    ...
    def __init__(
        ...
        directory_services=None,  # type: List[models.FixedReferenceWithType]
        dns=None,  # type: List[models.FixedReferenceWithType]
        ...
        Keyword args:
            ...
            directory_services (list[FixedReferenceWithType]): The directory service config to be used by this server.
            dns (list[FixedReferenceWithType]): The DNS config to be used by this server.
            local_directory_service (FixedReferenceWithType): The Local Directory Service associated to the server.
        """
        if id is not None:
            self.id = id
        if name is not None:
