...
class VolumeSnapshotTransferGetResponse(object):
    ...
    def __init__(
        ...
        items=None,  # type: List[models.VolumeSnapshotTransfer]
        errors=None,  # type: List[models.ErrorcontextresponseErrors]
        total=None,  # type: List[models.VolumeSnapshotTransfer]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `VolumeSnapshotTransferGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(VolumeSnapshotTransferGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VolumeSnapshotTransferGetResponse):
            return False
