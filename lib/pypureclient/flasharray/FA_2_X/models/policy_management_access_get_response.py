...
class PolicyManagementAccessGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[PolicyManagementAccess]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PolicyManagementAccess]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyManagementAccessGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyManagementAccessGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyManagementAccessGetResponse):
            return False
