...
class ResourceDirectorySpaceGetResponse(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            items (list[ResourceDirectorySpace]): Displays a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty. 
