...
class RemoteVolumeSnapshotTransferGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'total': 'list[RemoteVolumeSnapshotTransfer]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.RemoteVolumeSnapshotTransfer]
        errors=None,  # type: List[models.ErrorcontextresponseErrors]
        total=None,  # type: List[models.RemoteVolumeSnapshotTransfer]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `RemoteVolumeSnapshotTransferGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(RemoteVolumeSnapshotTransferGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoteVolumeSnapshotTransferGetResponse):
            return False
