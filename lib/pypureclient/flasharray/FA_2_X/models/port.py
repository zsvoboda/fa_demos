...
class Port(object):
    ...
    def __init__(
        ...
        Keyword args:
            ...
            hw_encryption (str): Indicates whether the array port supports encryption. 
        """
        if name is not None:
            self.name = name
        if iqn is not None:
        ...
        if hw_encryption is not None:
            self.hw_encryption = hw_encryption
