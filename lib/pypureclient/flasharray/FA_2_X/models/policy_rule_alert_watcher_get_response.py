...
class PolicyRuleAlertWatcherGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[PolicyRuleAlertWatcher]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PolicyRuleAlertWatcher]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyRuleAlertWatcherGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyRuleAlertWatcherGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleAlertWatcherGetResponse):
            return False
