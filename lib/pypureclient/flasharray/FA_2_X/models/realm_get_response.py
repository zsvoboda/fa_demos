...
class RealmGetResponse(object):
    ...
    def __init__(
        ...
        items=None,  # type: List[models.Realm]
        errors=None,  # type: List[models.ErrorcontextresponseErrors]
        total=None,  # type: List[models.Realm]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `RealmGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(RealmGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RealmGetResponse):
            return False
