...
class MemberNoIdAllGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.MemberNoIdAll]
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `MemberNoIdAllGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(MemberNoIdAllGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MemberNoIdAllGetResponse):
            return False
