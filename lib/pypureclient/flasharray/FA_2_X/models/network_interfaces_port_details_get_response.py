...
class NetworkInterfacesPortDetailsGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[NetworkInterfacesPortDetails]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.NetworkInterfacesPortDetails]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `NetworkInterfacesPortDetailsGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(NetworkInterfacesPortDetailsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkInterfacesPortDetailsGetResponse):
            return False
