...
class PolicyLockableGetResponse(object):
    """
    Attributes:
    ...
    def __init__(
        ...
        items=None,  # type: List[models.PolicyLockable]
        ...
        Keyword args:
            ...
            items (list[PolicyLockable]): Displays a list of all items after filtering. If applicable, the values are displayed for each name. 
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `PolicyLockableGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(PolicyLockableGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyLockableGetResponse):
            return False
