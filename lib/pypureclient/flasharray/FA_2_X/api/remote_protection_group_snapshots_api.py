...
class RemoteProtectionGroupSnapshotsApi(object):
    ...
    def api2_x_remote_protection_group_snapshots_delete_with_http_info(
        self,
        ...
        >>> thread = api.api2_x_remote_protection_group_snapshots_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_remote_protection_group_snapshots_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_remote_protection_group_snapshots_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_remote_protection_group_snapshots_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_remote_protection_group_snapshots_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_remote_protection_group_snapshots_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_remote_protection_group_snapshots_patch_with_http_info(remote_protection_group_snapshot, async_req=True)
        >>> result = thread.get()
        ...
        if remote_protection_group_snapshot is None:
            raise TypeError("Missing the required parameter `remote_protection_group_snapshot` when calling `api2_x_remote_protection_group_snapshots_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_remote_protection_group_snapshots_post_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_remote_protection_group_snapshots_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_remote_protection_group_snapshots_test_post_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        context_names=None,  # type: List[str]
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_remote_protection_group_snapshots_test_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots/test', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_remote_protection_group_snapshots_transfer_get_with_http_info(
        self,
        authorization=None,  # type: str
        x_request_id=None,  # type: str
        allow_errors=None,  # type: bool
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_remote_protection_group_snapshots_transfer_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_remote_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_remote_protection_group_snapshots_transfer_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.X/remote-protection-group-snapshots/transfer', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
