...
class ContainerDefaultProtectionsApi(object):
    ...
    def api2_x_container_default_protections_get_with_http_info(
        self,
        ...
        >>> thread = api.api2_x_container_default_protections_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api2_x_container_default_protections_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api2_x_container_default_protections_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
        ...
        return self.api_client.call_api(
            '/api/2.X/container-default-protections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api2_x_container_default_protections_patch_with_http_info(
        self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api2_x_container_default_protections_patch_with_http_info(container_default_protection, async_req=True)
        >>> result = thread.get()
        ...
        if container_default_protection is None:
            raise TypeError("Missing the required parameter `container_default_protection` when calling `api2_x_container_default_protections_patch`")
        ...
        return self.api_client.call_api(
            '/api/2.X/container-default-protections', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
