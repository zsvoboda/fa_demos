...
class NetworkInterfacePerformanceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[NetworkInterfacePerformance]',
    ...
    def __init__(
        ...
        items=None,  # type: List[models.NetworkInterfacePerformance]
        total=None,  # type: List[models.NetworkInterfacePerformance]
    ):
        """
        Keyword args:
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `NetworkInterfacePerformanceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(NetworkInterfacePerformanceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkInterfacePerformanceGetResponse):
            return False
