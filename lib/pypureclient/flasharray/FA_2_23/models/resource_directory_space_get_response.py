...
class ResourceDirectorySpaceGetResponse(object):
    """
    Attributes:
    ...
    swagger_types = {
        ...
        'items': 'list[ResourceDirectorySpace]',
        'total': 'list[ResourceDirectorySpace]'
    }
    ...
    def __init__(
        ...
        items=None,  # type: List[models.ResourceDirectorySpace]
        total=None,  # type: List[models.ResourceDirectorySpace]
    ):
        """
        Keyword args:
            ...
            total (list[ResourceDirectorySpace]): The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field. 
        """
    ...
    def __setattr__(self, key, value):
        if key not in self.attribute_map:
            raise KeyError("Invalid key `{}` for `ResourceDirectorySpaceGetResponse`".format(key))
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            if hasattr(self, attr):
                ...
                if isinstance(value, list):
                    ...
                    result[attr] = value
        if issubclass(ResourceDirectorySpaceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceDirectorySpaceGetResponse):
            return False
