...
class VolumesApi(object):
    ...
    def api236_volumes_batch_post_with_http_info(
        ...
        >>> thread = api.api236_volumes_batch_post_with_http_info(volume, async_req=True)
        >>> result = thread.get()
        ...
        if volume is None:
            raise TypeError("Missing the required parameter `volume` when calling `api236_volumes_batch_post`")
    ...
    def api236_volumes_batch_test_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_batch_test_post_with_http_info(volume, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume' is set
        if volume is None:
            raise TypeError("Missing the required parameter `volume` when calling `api236_volumes_batch_test_post`")
    ...
    def api236_volumes_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api236_volumes_diff_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_diff_get_with_http_info(segment_length, block_size, async_req=True)
        >>> result = thread.get()
        ...
        if segment_length is None:
            raise TypeError("Missing the required parameter `segment_length` when calling `api236_volumes_diff_get`")
        # verify the required parameter 'block_size' is set
        if block_size is None:
            raise TypeError("Missing the required parameter `block_size` when calling `api236_volumes_diff_get`")

        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_diff_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_diff_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_patch_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_patch_with_http_info(volume, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume' is set
        if volume is None:
            raise TypeError("Missing the required parameter `volume` when calling `api236_volumes_patch`")
    ...
    def api236_volumes_performance_by_array_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_performance_by_array_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'resolution' in params and params['resolution'] < 0:
            raise ValueError("Invalid value for parameter `resolution` when calling `api236_volumes_performance_by_array_get`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_performance_by_array_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_performance_by_array_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_performance_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_performance_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'resolution' in params and params['resolution'] < 0:
            raise ValueError("Invalid value for parameter `resolution` when calling `api236_volumes_performance_get`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_performance_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_performance_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_post_with_http_info(volume, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume' is set
        if volume is None:
            raise TypeError("Missing the required parameter `volume` when calling `api236_volumes_post`")
    ...
    def api236_volumes_protection_groups_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_protection_groups_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api236_volumes_protection_groups_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_protection_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_protection_groups_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_protection_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_protection_groups_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_protection_groups_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api236_volumes_space_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_space_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'resolution' in params and params['resolution'] < 0:
            raise ValueError("Invalid value for parameter `resolution` when calling `api236_volumes_space_get`, must be a value greater than or equal to `0`")
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_space_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_space_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_tags_batch_put_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_tags_batch_put_with_http_info(tag, async_req=True)
        >>> result = thread.get()
        ...
        if tag is None:
            raise TypeError("Missing the required parameter `tag` when calling `api236_volumes_tags_batch_put`")
    ...
    def api236_volumes_tags_delete_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_tags_delete_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def api236_volumes_tags_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_tags_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_tags_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_tags_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
    ...
    def api236_volumes_test_post_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_test_post_with_http_info(volume, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'volume' is set
        if volume is None:
            raise TypeError("Missing the required parameter `volume` when calling `api236_volumes_test_post`")
    ...
    def api236_volumes_volume_groups_get_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api236_volumes_volume_groups_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'limit' in params and params['limit'] < 0:
            raise ValueError("Invalid value for parameter `limit` when calling `api236_volumes_volume_groups_get`, must be a value greater than or equal to `0`")
        if 'offset' in params and params['offset'] < 0:
            raise ValueError("Invalid value for parameter `offset` when calling `api236_volumes_volume_groups_get`, must be a value greater than or equal to `0`")
        collection_formats = {}
        path_params = {}
